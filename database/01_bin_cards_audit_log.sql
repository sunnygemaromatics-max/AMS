-- ============================================================
-- BIN CARDS & AUDIT TRAIL SETUP - Phase 2 (Safe Version)
-- ============================================================
...
DROP TABLE IF EXISTS public.bin_card_entries CASCADE;

CREATE TABLE public.bin_card_entries (
    ...
    -- Who and why (use simple TEXT instead of foreign keys for now)
    created_by_id UUID,
...
-- Create indexes
CREATE INDEX idx_bin_card_entries_asset ON public.bin_card_entries(asset_id);
CREATE INDEX idx_bin_card_entries_date ON public.bin_card_entries(entry_date DESC);
CREATE INDEX idx_bin_card_entries_type ON public.bin_card_entries(transaction_type);

-- ============================================================
-- 2. AUDIT LOG TABLE (Simplified - no foreign key constraints)
-- ============================================================
...
CREATE TABLE public.audit_log (
    ...
    -- Who made the change (simple TEXT columns)
    user_id UUID,
    user_name TEXT,
    user_role TEXT,
...
-- Function to add bin card entry
...
SELECT '  • get_asset_balance(p_asset_id)' as detail;
SELECT '  • add_bin_card_entry(...)' as detail;
SELECT '  • log_audit(...)' as detail;
