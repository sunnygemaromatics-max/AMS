export function parseDbError(err: unknown): string {
  ...
  const codes: Record<string, string> = {
    ...
    "42501": "Permission denied — your account may need approval or a higher role (admin/it required)",
    ...
    "PGRST204": "Permission denied — your account needs admin/IT role AND approval status. Contact your system administrator to approve your account.",
  };
