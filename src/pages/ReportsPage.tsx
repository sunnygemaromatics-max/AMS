...
const CATEGORY_DEFINITIONS = [
  ...
  // ── 5. Additional IT & Other ──
  // (a) restored legacy cards that pre-dated the PDF-aligned rewrite
  { id: 21, category: "Additional IT & Other", description: "Email Accounts", coverage: "All Locations", icon: Mail, color: "bg-indigo-500",
    filter: (a: any) => sub(a) === 'email_account' },
  { id: 22, category: "Additional IT & Other", description: "Network Infrastructure", coverage: "All Locations", icon: Network, color: "bg-indigo-600",
    filter: (a: any) => sub(a) === 'networking' },
  { id: 23, category: "Additional IT & Other", description: "Internet Connections", coverage: "All Locations", icon: Wifi, color: "bg-cyan-500",
    filter: (a: any) => sub(a) === 'internet_connection' || nameHas(a, 'internet', 'broadband', 'leased line', 'isp', 'fiber') },
  { id: 24, category: "Additional IT & Other", description: "IP Phones & Intercom", coverage: "All Locations", icon: Phone, color: "bg-cyan-600",
    filter: (a: any) => sub(a) === 'ip_phone' || nameHas(a, 'ip phone', 'intercom', 'epabx', 'landline', 'telephone') },
  { id: 25, category: "Additional IT & Other", description: "Company Mobiles", coverage: "All Locations", icon: Phone, color: "bg-pink-500",
    filter: (a: any) => sub(a) === 'mobile_device' || sub(a) === 'tablet' },
  { id: 26, category: "Additional IT & Other", description: "Domain Management", coverage: "All Company", icon: Globe, color: "bg-violet-600",
    filter: (a: any) => sub(a) === 'domain' || nameHas(a, 'domain', 'godaddy', 'namecheap', 'dns') },
  { id: 27, category: "Additional IT & Other", description: "Scanner", coverage: "All Locations", icon: FileText, color: "bg-sky-700",
    filter: (a: any) => sub(a) === 'scanner' },
  { id: 28, category: "Additional IT & Other", description: "UPS", coverage: "All Locations", icon: Server, color: "bg-amber-500",
    filter: (a: any) => sub(a) === 'ups' || nameHas(a, 'ups ', 'uninterruptible') },
  // (b) standard ITAM types from research (hardware / software / cloud / digital)
  { id: 29, category: "Additional IT & Other", description: "Monitor / Display", coverage: "All Locations", icon: Monitor, color: "bg-blue-400",
    filter: (a: any) => sub(a) === 'monitor' || nameHas(a, 'monitor', 'display screen', 'lcd', 'led monitor') },
  { id: 30, category: "Additional IT & Other", description: "Router", coverage: "All Locations", icon: Network, color: "bg-red-400",
    filter: (a: any) => sub(a) === 'router' || (sub(a) === 'networking' && nameHas(a, 'router')) },
  { id: 31, category: "Additional IT & Other", description: "Network Switch", coverage: "All Locations", icon: Network, color: "bg-red-500",
    filter: (a: any) => sub(a) === 'switch' || (sub(a) === 'networking' && nameHas(a, 'switch')) },
  { id: 32, category: "Additional IT & Other", description: "Access Point / WiFi", coverage: "All Locations", icon: Wifi, color: "bg-cyan-700",
    filter: (a: any) => sub(a) === 'access_point' || nameHas(a, 'access point', 'wifi', 'wi-fi', 'wlan ap') },
  { id: 33, category: "Additional IT & Other", description: "Modem", coverage: "All Locations", icon: Wifi, color: "bg-cyan-800",
    filter: (a: any) => sub(a) === 'modem' || nameHas(a, 'modem') },
  { id: 34, category: "Additional IT & Other", description: "Docking Station", coverage: "All Locations", icon: Monitor, color: "bg-slate-500",
    filter: (a: any) => sub(a) === 'docking_station' || nameHas(a, 'docking', 'dock station') },
  { id: 35, category: "Additional IT & Other", description: "Projector", coverage: "All Locations", icon: Monitor, color: "bg-slate-600",
    filter: (a: any) => sub(a) === 'projector' || nameHas(a, 'projector', 'beamer') },
  { id: 36, category: "Additional IT & Other", description: "Peripheral (KB/Mouse/Webcam)", coverage: "All Locations", icon: Key, color: "bg-slate-700",
    filter: (a: any) => sub(a) === 'peripheral' || nameHas(a, 'keyboard', 'mouse', 'webcam', 'headset', 'speaker') },
  { id: 37, category: "Additional IT & Other", description: "Biometric Device", coverage: "All Locations", icon: Shield, color: "bg-purple-800",
    filter: (a: any) => sub(a) === 'biometric_device' || nameHas(a, 'biometric', 'fingerprint', 'face reader', 'attendance machine') },
  { id: 38, category: "Additional IT & Other", description: "Rack / Network Cabinet", coverage: "All Locations", icon: Server, color: "bg-amber-700",
    filter: (a: any) => sub(a) === 'rack' || nameHas(a, 'rack', 'network cabinet', 'server cabinet') },
  { id: 39, category: "Additional IT & Other", description: "Inverter / Power Backup", coverage: "All Locations", icon: Server, color: "bg-amber-800",
    filter: (a: any) => sub(a) === 'inverter' || nameHas(a, 'inverter', 'power backup', 'battery backup') },
  { id: 40, category: "Additional IT & Other", description: "SIM / Data Card / Dongle", coverage: "All Locations", icon: Phone, color: "bg-pink-600",
    filter: (a: any) => sub(a) === 'sim_card' || nameHas(a, 'sim card', 'data card', 'dongle', 'datacard') },
  { id: 41, category: "Additional IT & Other", description: "Operating System License", coverage: "All Locations", icon: FileCode, color: "bg-green-700",
    filter: (a: any) => sub(a) === 'os_license' || nameHas(a, 'windows license', 'linux license', 'os license', 'windows server') },
  { id: 42, category: "Additional IT & Other", description: "Database License", coverage: "All Locations", icon: FileCode, color: "bg-green-800",
    filter: (a: any) => sub(a) === 'database_license' || nameHas(a, 'sql server', 'oracle license', 'database license', 'postgres license') },
  { id: 43, category: "Additional IT & Other", description: "Cloud Subscription", coverage: "All Company", icon: Globe, color: "bg-blue-700",
    filter: (a: any) => sub(a) === 'cloud_subscription' || nameHas(a, 'aws', 'azure', 'gcp', 'cloud subscription', 'digitalocean') },
  { id: 44, category: "Additional IT & Other", description: "SaaS Subscription", coverage: "All Company", icon: Globe, color: "bg-blue-800",
    filter: (a: any) => sub(a) === 'saas_subscription' || nameHas(a, 'saas', 'zoom', 'slack', 'dropbox', 'subscription') },
  { id: 45, category: "Additional IT & Other", description: "SSL Certificate", coverage: "All Company", icon: Shield, color: "bg-red-700",
    filter: (a: any) => sub(a) === 'ssl_certificate' || nameHas(a, 'ssl', 'tls certificate', 'certificate') },
  { id: 46, category: "Additional IT & Other", description: "VPN License", coverage: "All Locations", icon: Shield, color: "bg-red-800",
    filter: (a: any) => sub(a) === 'vpn_license' || nameHas(a, 'vpn') },
];
